...
" Function calls
syn region FCall matchgroup=FName start='[[:alpha:]_]\i*\s*(' end=')'
    \ contains=FCall,FCallKeyword,pythonString,pythonNumber,pythonConditional,pythonOperator,pythonBuiltin,pythonSelf,pythonGlobal,pythonMagic
    \ transparent
syn match FCallKeyword /\i*\ze\s*=[^=]/ contained
syn keyword pythonSelf self cls
syn match pythonGlobal "\<[A-Z0-9_]*\>"
